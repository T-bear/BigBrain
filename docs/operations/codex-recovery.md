...
No interrupted run is active. The BB-130C backtest-result-identity candidate was merged to
main and CI verified at `f0b4dbd73c50047c078227edff0bf9c0d5aa7bde` (Actions
`34082759615`). The published repository is again the complete source of truth.

...
- `BB-130D cleanup, 2026-09-14` — [Backend whitespace-only cleanup: clean local format baseline; REVIEW CANDIDATE ONLY](features/platform/bb-130d-backend-whitespace-cleanup-20260914.md). CI gate not enabled; D2 not started.

...
The iOS capture status is unchanged: **FULL-PAGE IOS SAFARI SCREENSHOT ARTIFACT: STILL REPRODUCIBLE** according to real-iPhone owner evidence and is not visible in normal interaction. This craftsmanship pass neither claims nor attempts an unverified fix. Publication, CI, deployment and deployed-state evidence are appended after those gates complete. **OWNER VISUAL APPROVAL PENDING.**

...
The appliance was updated from an older image to repository HEAD and commissioned at 20:55 UTC through the deployment-only `FINANCE__RESEARCHSCHEDULER__ENABLED=true` override. Source defaults remain off. The deployed schedule is one 02:00 UTC opportunity checked every 60 minutes with at most two experiments; maintenance pause is false. Recovery was healthy/clean, Sentinel-backed governor evidence returned `ALLOW`, EODHD remained authorized over the same eight-symbol cadence and Finance remained `RESEARCH / 0 SEK / NONE`. The final narrow correction was published as `5cc35f415c5314f702c719f0114979ac3f8a3821`, passed GitHub Actions run 32598337042 and was deployed as API image `sha256:8f916403e8a672a7fe1aa6dc76e14cbcb86c9312bbb1e1fb35070af847153a2a`.

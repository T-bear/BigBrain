...
**Owner-directed polish (2026-08-23): IN PROGRESS — owner visual approval not granted.** Real-iPhone evidence supersedes the previous headless artifact conclusion: `FULL-PAGE IOS SAFARI SCREENSHOT ARTIFACT: STILL REPRODUCIBLE` for both dark themes and is absent during normal use. Family architecture and functionality remain frozen. Two controlled normal-viewport iterations have refined Obsidian material/gold, Forest environment/material, typography hierarchy, meal density/separators, Today, tabs, Shopping hierarchy and dock detail. Publication, full CI, Web-only deployment and deployed viewport verification remain before technical completion; owner approval remains a separate gate.

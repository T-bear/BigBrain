...
No scientific math/identity change. Web is byte-identical to baseline; publication CI also passed frontend install/format/test/build.
...
[A–D criteria matrix, accepted evidence and debt classification](docs/reports/features/platform/bb-130-final-exit-assessment-20260921.md).
...
[Commands, negative characterization and limitations](docs/reports/features/platform/bb-130d2-frontend-formatter-ci-gate-20260921.md).

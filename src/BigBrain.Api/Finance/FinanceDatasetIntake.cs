...
public sealed record DatasetCatalogItem(string CandidateId, string OriginalFilename, string Source, string SourceUrl, string HostingPlatform,
    ...
    string Encoding, string Delimiter, IReadOnlyList<string> Headers);

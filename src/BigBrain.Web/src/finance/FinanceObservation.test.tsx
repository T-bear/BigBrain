...
const empty: FinanceObservationSnapshot = {
  ...
  safety: {
    ...
    realProviderStorageAllowed: false,
  },
  provider: {
    state: 'noneAuthorized',
    displayName: 'Ingen',
    entitlement: 'pendingWrittenConfirmation',
    entitlementGate: 'BB-071 / STATE B',
    reason: 'Skriftlig entitlement-bekräftelse saknas.',
  },
  latestMarketDataUpdateUtc: null,
  dataKind: 'none',
  watchlist: [
    {
  ...
  historicalMemory: {
    ...
    coverageFrom: null,
    coverageTo: null,
    lastAcquiredAtUtc: null,
    gapCount: 0,
    correctionCount: 0,
    persistence: 'notConfigured',
    provider: 'none',
    product: 'none',
    policy: 'BB-071-pending',
    provenance: 'none',
  },
}
const featureFixture: FinanceFeatureSnapshot = {
  generatedAtUtc: '2026-08-11T18:00:00Z',
  operatingMode: 'research',
  featureSetId: 'core-daily-v1',
  instrumentId: 'US:XNAS:MSFT',
  definitions: [],
  revision: {
    revisionId: 'feature-revision-1',
    featureSetId: 'core-daily-v1',
    featureSetFingerprint: 'sha256:set',
    engineVersion: 'daily-feature-engine-v1',
    sourceMarketRevisions: ['market-revision-1'],
    coverageFrom: '2026-08-07',
    coverageTo: '2026-08-10',
    valueCount: 42,
    availableCount: 7,
    warmupCount: 35,
    qualityIssueCount: 0,
    ...
    buildElapsedMilliseconds: 12,
    priceBasis: 'raw close/OHLC',
    persistence: 'durable',
  },
  latest: [
    {
      ...
      state: 'available',
      quality: 'good',
      knowledgeTimeUtc: '2026-08-11T18:00:00Z',
    },
    {
      definitionId: 'rsi.14',
      name: 'RSI 14',
  ...
  historyDefinitionId: 'sma.20',
  history: [],
}
const backupFixture: FinanceBackupInventory = {
  generatedAtUtc: '2026-08-15T18:00:00Z',
  operatingMode: 'RESEARCH',
  backups: [
    {
      backupId: 'finance-backup-fixture',
      createdAtUtc: '2026-08-15T18:00:00Z',
      schemaVersion: 'finance-provider-backup-v1',
      bigBrainVersion: 'test',
      status: 'Complete',
      sources: [
        {
          provider: 'NASDAQ-WIKI',
          product: 'WIKI/PRICES',
          rightsClass: 'PublicDomain',
          retentionClass: 'Indefinite',
          deletionRequirement: 'None',
          deletionDeadlineUtc: null,
      ...
      revisions: [
        {
          revisionId: 'wiki-fixture',
          provider: 'NASDAQ-WIKI',
          product: 'WIKI/PRICES',
          policy: 'dataset-promotion-v1',
          checksum: 'sha256:fixture',
          observationCount: 50,
          coverageFrom: '2016-01-01',
          coverageTo: '2016-02-19',
        },
      ],
      featureRevisionIds: ['feature-fixture'],
      backtestRunIds: [],
      robustnessEvaluationIds: [],
      artifacts: [{ path: 'fixture.data.json', bytes: 100, sha256: 'sha256:fixture' }],
  ...
  sourcePolicies: [
    ...
    },
    {
      provider: 'EODHD',
      product: 'Free',
      rightsClass: 'OwnerAcceptedPersonalResearch',
      retentionClass: 'SubscriptionOnly',
      deletionRequirement: 'DeleteAtSubscriptionEnd',
      deletionDeadlineUtc: null,
      backupEligibility: 'Restricted',
      restoreEligible: true,
      reason: 'provider-specific',
    },
  ],
}
const overviewFixture: FinanceOverview = {
  generatedAtUtc: '2026-08-15T19:00:00Z',
  mode: 'RESEARCH',
  provider: 'EODHD',
  observationClass: 'CURRENT EOD / PROSPECTIVE EOD',
  latestSession: '2026-08-14',
  freshness: 'CURRENT EOD',
  tracked: 2,
  up: 1,
  down: 1,
  unchanged: 0,
  marketSummary:
    '1 av 2 bevakade instrument steg under senaste tillgängliga marknadssessionen; 1 föll och 0 var oförändrade.',
  signals: [
    {
      ...
      name: 'Apple',
      state: 'POSITIVE',
      sessionChangePercent: 1.2,
      positiveStrategies: 2,
      neutralStrategies: 0,
      negativeStrategies: 1,
      strategyCount: 3,
      agreement: '2/3 strategies agree; positive 2, neutral 0, negative 1',
      freshness: 'Delayed',
    },
    {
      instrumentId: 'US:XNAS:MSFT',
      ...
      name: 'Microsoft',
      state: 'NEUTRAL',
      sessionChangePercent: -0.2,
      positiveStrategies: 1,
      neutralStrategies: 1,
      negativeStrategies: 1,
      strategyCount: 3,
      agreement: '1/3 strategies agree; positive 1, neutral 1, negative 1',
      freshness: 'Delayed',
    },
  ],
  prospective: {
    ...
    evidenceMaturity: 'BOOTSTRAPPING',
    curve: [],
  },
  cadence: {
    enabled: true,
    ...
    observationClass: 'CURRENT EOD / PROSPECTIVE EOD',
    health: 'Healthy',
    lastProviderCheckUtc: '2026-08-15T19:00:00Z',
    lastSuccessfulAcquisitionUtc: null,
    latestCanonicalSession: '2026-08-14',
    lastPredictionUtc: '2026-08-15T18:00:00Z',
    lastOutcomeUtc: null,
    pending: 24,
    evaluated: 0,
    invalidated: 24,
    clockIntegrity: true,
    nextAction: 'Waiting for next weekday EOD provider window',
    pollingPolicy: 'internal check every 30 minutes',
    operatingMode: 'RESEARCH',
  },
  disclaimer: 'Research results — no money is traded. Signals are not recommendations.',
  evidenceSeparation:
    'Prospective evidence records prior decisions; historical backtests remain separate and are not included.',
}
const riskStatusFixture: FinanceRiskStatus = {
  policyVersion: 'research-eod-v1',
  operatingMode: 'RESEARCH',
  ...
  haltedAtUtc: null,
  evaluationCount: 1,
  lastEvaluationUtc: '2026-08-16T10:00:00Z',
  executionAuthority: 'NONE — research evidence only; no orders',
}
const riskEvaluationFixture: FinanceRiskEvaluation = {
  evaluationId: 'risk-fixture',
  policyVersion: 'research-eod-v1',
  proposalId: 'proposal-fixture',
  instrumentId: 'US:XNAS:AAPL',
  strategyId: 'momentum',
  strategyVersion: 'v1',
  parameterFingerprint: 'sha256:fixture',
  shadowPredictionId: 'shadow-fixture',
  sourceRevisionId: 'source-fixture',
  featureRevisionId: 'feature-fixture',
  knowledgeCutoffUtc: '2026-08-16T09:59:00Z',
  evaluatedAtUtc: '2026-08-16T10:00:00Z',
  operatingMode: 'RESEARCH',
  direction: 'TargetLong',
  researchCapital: 100000,
  requestedExposure: 4000,
  allowedExposure: 4000,
  riskAdjustedExposure: 4000,
  verdict: 'allow',
  reasonCodes: [],
  rules: [],
  evidenceLineage: 'source=source-fixture',
}
const autonomousFixture: FinanceAutonomousResearch = {
  generatedAtUtc: '2026-08-22T10:00:00Z',
  operatingMode: 'RESEARCH',
  budgetSek: 0,
  engineVersion: 'autonomous-research-v1',
  featureLibraryVersion: 'finance-research-signals-v1',
  totalExperiments: 1,
  rejectedCount: 1,
  inconclusiveCount: 0,
  notEvaluableCount: 0,
    ...
    experiments: [
      {
        ...
        familyId: 'family-momentum-v1',
        familyAttemptCount: 3,
        attemptCount: 3,
        runId: 'research-run-fixture',
        runIds: ['research-run-fixture'],
        verdict: 'rejected',
        rejectionReason: 'integrity.out-of-sample.failed',
        outOfSampleNetReturn: -0.02,
        costModel: 'hypothetical-conservative-v1',
        featureRevisionId: 'feature-fixture',
        marketRevisionIds: ['market-fixture'],
        knowledgeCutoffUtc: '2026-08-21T22:00:00Z',
        complexity: { score: 6 },
        integrity: {
          state: 'fail',
          checks: [
            { id: 'out-of-sample', state: 'fail', evidence: 'net=-0.02' },
            { id: 'dsr', state: 'notEvaluable', evidence: 'inputs unavailable' },
          ],
        },
      },
    ],
...
const schedulerFixture: FinanceResearchSchedulerStatus = {
  currentUtc: '2026-08-23T01:00:00Z',
  enabled: true,
  schedulerVersion: 'finance-research-scheduler-v1',
  nextDueUtc: '2026-08-23T02:00:00Z',
  lastOpportunity: {
    opportunityId: 'finance-research-scheduler-v1:2026-08-22',
    researchDate: '2026-08-22',
    dueAtUtc: '2026-08-23T02:00:00Z',
    attemptedAtUtc: '2026-08-23T02:03:00Z',
    completedAtUtc: '2026-08-23T02:04:00Z',
    state: 'Completed',
    researchRunId: 'research-run-fixture',
    reason: 'finance.research.scheduler.completed',
    nextEligibilityUtc: null,
  },
  lastResearchRunId: 'research-run-fixture',
  lastOutcome: 'Completed',
  lastReason: 'finance.research.scheduler.completed',
  researchCurrentlyRunning: false,
  operatingMode: 'RESEARCH',
  budgetSek: 0,
  executionAuthority: 'NONE',
  historicalEvidenceAvailable: true,
  currentSessionRequired: true,
  requiredResearchDate: '2026-08-22',
  currentSessionReadiness: 'COMPLETE',
  featureLineageReadiness: 'READY',
  dataReady: true,
  readinessReason: 'finance.research.scheduler.ready',
  currentInstrumentCount: 8,
  expectedInstrumentCount: 8,
}
const governorFixture: FinanceResearchResourceDecision = {
  decision: 'defer',
  evaluatedAtUtc: '2026-08-23T01:00:00Z',
  governorVersion: 'finance-research-resource-governor-v1',
  reasonCodes: ['finance.research.scheduler.resource.memory'],
  evidence: {
    cpuUsagePercent: 32,
    memoryUsagePercent: 88,
    availableMemoryBytes: 536870912,
    minimumAvailableDiskBytes: 107374182400,
    availableDiskCount: 1,
    temperatureCelsius: null,
    temperatureSupported: false,
    metricsStatus: 'Healthy',
    collectedAtUtc: '2026-08-23T01:00:00Z',
  },
  operatingMode: 'RESEARCH',
  budgetSek: 0,
  executionAuthority: 'NONE',
}
const operationsFixture: FinanceResearchOperationsStatus = {
  operationsVersion: 'finance-research-operations-v1',
  evaluatedAtUtc: '2026-08-23T03:00:00Z',
  state: 'attentionRequired',
  requiresAttention: true,
  currentActivity: 'OPERATIONAL_FAILURE_STREAK',
  schedulerEnabled: true,
  maintenancePaused: false,
  lastSchedulerEvaluationUtc: '2026-08-23T03:00:00Z',
  lastSuccessfulResearchUtc: '2026-08-22T02:04:00Z',
  lastOperationalFailureUtc: '2026-08-23T03:00:00Z',
  consecutiveOperationalFailures: 3,
  lastFailureReason: 'finance.research.scheduler.unexpected.SqliteException',
  lastSuccessfulEvidenceRefreshUtc: '2026-08-22T22:10:00Z',
  historicalEvidenceAvailable: true,
  currentSessionRequired: true,
  requiredResearchDate: '2026-08-22',
  dataReadiness: 'COMPLETE',
  featureLineageReadiness: 'READY',
...
const backtestCatalog: FinanceBacktestCatalog = {
  ...
  runs: ['first', 'second', 'third'].map(id => ({
    ...
    excessReturn: null,
    marketRevisionIds: ['fixture-market'],
    featureRevisionId: 'fixture-feature',
    simulationModel: 'fixture',
    sizingPolicy: 'fixture',
    status: 'complete',
    limitations: [],
  })),
}
const backtestResultFixture: FinanceBacktestResult = {
  ...
  events: [],
  metrics: {},
  equityCurve: [0, 1].map(day => ({
    session: `2020-01-0${day + 1}`,
    cash: 100,
    holdingsValue: day,
    totalEquity: 100 + day,
    drawdown: 0,
...
describe('Finance read-only observation UI', () => {
  test('nine detail reads abort on close, restart on reopen, and ignore ordinary observation refresh', async () => {
    ...
    const details = [
      vi.spyOn(api, 'getFinanceBacktests'),
      vi.spyOn(api, 'getFinanceRobustness'),
      vi.spyOn(api, 'getFinanceDatasets'),
      vi.spyOn(api, 'getFinanceBackups'),
      vi.spyOn(api, 'getFinanceShadow'),
      vi.spyOn(api, 'getFinanceResearchSchedulerStatus'),
      vi.spyOn(api, 'getFinanceResearchGovernorStatus'),
  ...
  test('backtest catalog selects first result; close does not abort selected-result read and reopen does not refetch same ID', async () => {
    ...
    const result = vi.spyOn(api, 'getFinanceBacktest').mockImplementation(
      () =>
        new Promise(resolve => {
          finish = resolve
        }),
  ...
  test('rapid A to B to C ignores stale B completion and shows only C result', async () => {
    ...
    await act(async () => {
      pending[1].resolve({ ...backtestResultFixture, runId: 'second', checksum: 'checksum-second' })
    })
    ...
    await act(async () => {
      pending[2].resolve({ ...backtestResultFixture, runId: 'third', checksum: 'checksum-third' })
    })
    expect(screen.getByLabelText('Equity curve och drawdown')).toBeVisible()
  ...
  test('backtest selection never pairs new summary with prior curve while pending or failed', async () => {
    ...
    const result = vi
      .spyOn(api, 'getFinanceBacktest')
      .mockResolvedValueOnce(backtestResultFixture)
      .mockImplementation(
        () =>
    ...
    expect(screen.queryByLabelText('Equity curve och drawdown')).not.toBeInTheDocument()
    await act(async () => {
      rejectSecond(new Error('unavailable'))
    })
    expect(screen.queryByLabelText('Equity curve och drawdown')).not.toBeInTheDocument()
    expect(screen.getByText('second / checksum-second')).toBeVisible()
  ...
  test('hidden visibility does not refresh; online still recovers while hidden without overlap or polling', async () => {
    ...
    const observation = vi
      .spyOn(api, 'getFinanceObservation')
  ...
  test('StrictMode abort cleanup cannot clear the replacement in-flight refresh or overwrite its cache', async () => {
    ...
    const observation = vi.spyOn(api, 'getFinanceObservation').mockImplementation(
      signal =>
    ...
    await act(async () => {
      requests[2].finish({ ...empty, generatedAtUtc: '2026-09-06T10:00:00Z' })
    })
  ...
  test('first-load retry keeps the failure message and only a disabled accessible button loader until success', async () => {
    let finish: (value: FinanceObservationSnapshot) => void = () => {}
    vi.spyOn(api, 'getFinanceObservation')
  ...
  test('refresh preserves a user-selected instrument and falls back only when it leaves the observation', async () => {
    ...
    expect(features.mock.calls.map(([instrument]) => instrument)).toEqual([
      first.instrumentId,
      second.instrumentId,
      first.instrumentId,
    ])
  ...
  test('manual retry recovers in place without clearing cached content', async () => {
    ...
    const observation = vi
      ...
      .mockResolvedValueOnce({ ...empty, generatedAtUtc: '2026-09-02T18:06:00Z' })
    render(<FinanceObservation />)
    await screen.findByText('Uppdatering misslyckades')
    fireEvent.click(screen.getByRole('button', { name: 'Försök igen' }))
    expect(screen.getAllByText('Ingen handel med riktiga pengar')[0]).toBeVisible()
  ...
  test('does not overlap refreshes and revalidates once when connectivity returns', async () => {
    ...
    expect(
      screen.getAllByRole('status').filter(status => status.classList.contains('bb-loading-indicator')),
    ).toHaveLength(1)
    finish!(empty)
    await waitFor(() => expect(screen.queryByText('Visar senast hämtade data')).not.toBeInTheDocument())
  })
  ...
  test('cold observation renders before secondary reads and refresh does not restart them', async () => {
    ...
    vi.spyOn(api, 'getFinanceObservation').mockImplementation(
      () =>
        new Promise(resolve => {
  ...
  test('labels synthetic stale and gap evidence and keeps chart gap segments separate', () => {
    const fixture: FinanceObservationSnapshot = {
      ...empty,
      dataKind: 'syntheticFixture',
      latestMarketDataUpdateUtc: '2026-08-11T10:00:00Z',
      watchlist: [
        {
          ...empty.watchlist[0],
          price: 101,
          ...
          dataKind: 'syntheticFixture',
          history: [
            { observedAtUtc: '2026-08-11T09:00:00Z', value: 100, beginsAfterGap: false },
            { observedAtUtc: '2026-08-11T09:15:00Z', value: 101, beginsAfterGap: false },
            { observedAtUtc: '2026-08-11T10:00:00Z', value: 99, beginsAfterGap: true },
            { observedAtUtc: '2026-08-11T10:15:00Z', value: 101, beginsAfterGap: false },
          ],
        },
      ],
      historicalMemory: {
        ...empty.historicalMemory,
        observationCount: 4,
        activeRevisionId: 'fixture-revision-1',
        gapCount: 1,
        persistence: 'fixtureMemory',
      },
    }
  ...
  test('renders real EOD memory and compact retention state without live or trading claims', () => {
    const fixture: FinanceObservationSnapshot = {
      ...
      provider: {
        state: 'authorized',
        displayName: 'EODHD Free',
        entitlement: 'authorized',
        entitlementGate: 'EODHD FREE PERSONAL RESEARCH',
        reason: 'EOD-only',
        evidenceClass: 'ownerAcceptedPersonalResearch',
      },
      dataKind: 'real',
      latestMarketDataUpdateUtc: '2026-08-11T18:00:00Z',
      watchlist: [
        {
          ...empty.watchlist[0],
          price: 103,
          ...
          observedAtUtc: '2026-08-10T00:00:00Z',
          freshness: 'delayed',
          session: 'closed',
          quality: 'good',
          dataKind: 'real',
          history: [
            { observedAtUtc: '2026-08-07T00:00:00Z', value: 101.5, beginsAfterGap: false },
            { observedAtUtc: '2026-08-10T00:00:00Z', value: 103, beginsAfterGap: false },
          ],
        },
      ],
      historicalMemory: {
        ...empty.historicalMemory,
        observationCount: 2,
        activeRevisionId: 'eodhd-revision',
        coverageFrom: '2026-08-07',
        coverageTo: '2026-08-10',
        persistence: 'durable',
        provider: 'EODHD',
      ...
      retention: {
        state: 'active',
        entitlementEndsAtUtc: null,
        deletionDeadlineUtc: null,
        coveredObservationCount: 2,
        coveredRevisionCount: 1,
        coveredPayloadCount: 1,
        deletionScope: 'covered data',
        lastReceiptId: null,
        coveredFeatureValueCount: 42,
        coveredFeatureRevisionCount: 1,
      },
    }
    ...
    expect(
      screen.getByText(
        /2 observationer \/ 1 market-revisioner \/ 1 payloads \/ 42 feature-värden \/ 1 feature-revisioner/,
      ),
    ).toBeVisible()
  ...
  test('shows neutral insufficient out-of-sample evidence without optimization or trading controls', () => {
    const robustness: FinanceRobustnessCatalog = {
      generatedAtUtc: '2026-08-12T08:00:00Z',
      operatingMode: 'RESEARCH',
      plans: [],
      evaluations: [
        {
          ...
          planId: 'chronological-oos-walk-forward',
          planVersion: 'v1',
          strategyId: 'momentum',
          strategyVersion: 'v1',
          verdict: 'insufficientData',
          score: 58.09,
          evidenceLabel: 'mixedEvidence',
          trainSessions: 176,
          testSessions: 26,
          embargoSessions: 50,
          ...
          parameterVariants: 3,
          costVariants: 5,
          featureRevisionId: 'feature-1',
          marketRevisionIds: ['market-1'],
  ...
  test('distinguishes backed-up historical memory from canonical and provider-restricted evidence', () => {
    ...
    openResearchDetails()
    expect(screen.getAllByText('Dataskydd / Historiskt minne').at(-1)).toBeVisible()
    expect(screen.getByText('BACKED UP')).toBeVisible()
    expect(screen.getByText('finance-backup-fixture · 1 market-revisioner')).toBeVisible()
    expect(screen.getByText('NASDAQ-WIKI / WIKI/PRICES')).toBeVisible()
    expect(screen.getByText('EODHD / Free')).toBeVisible()
    expect(screen.getByText('SEPARAT FRÅN CANONICAL')).toBeVisible()
  ...
  test('separates prospective pending evidence from historical backtests and states sample limits', () => {
    const shadow: FinanceShadowCatalog = {
      generatedAtUtc: '2026-08-15T18:00:00Z',
      operatingMode: 'RESEARCH',
      observationClass: 'CURRENT EOD / PROSPECTIVE EOD',
      total: 1,
      ...
      predictions: [
        {
          predictionId: 'shadow-fixture',
          instrumentId: 'US:XNAS:AAPL',
          symbol: 'AAPL',
          sessionDate: '2026-08-14',
          provider: 'EODHD',
          sourceRevisionId: 'eodhd-fixture',
          observationKnowledgeUtc: '2026-08-15T17:00:00Z',
          knowledgeCutoffUtc: '2026-08-15T18:00:00Z',
          featureRevisionId: 'feature-fixture',
          strategyId: 'momentum',
          strategyVersion: 'v1',
          parameterFingerprint: 'sha256:fixture',
          signal: 'TargetLong',
          horizon: 'next-eligible-source-session-close-v1',
          createdAtUtc: '2026-08-15T18:00:00Z',
          state: 'pending',
          operatingMode: 'RESEARCH',
          reasonCodes: ['momentum.positive'],
        },
      ],
    }
    render(<FinanceObservation initialSnapshot={empty} initialShadow={shadow} />)
    openResearchDetails()
    expect(screen.getAllByText('Shadow research').at(-1)).toBeVisible()
    expect(screen.getByText('TargetLong · PENDING')).toBeVisible()
    expect(screen.getByText(/samplet bevisar pipelineintegritet, inte strategikvalitet/i)).toBeVisible()
    expect(screen.getAllByText('Backtests / Strategiforskning').at(-1)).toBeVisible()
    expect(screen.queryByRole('button', { name: /köp|sälj|order|trade/i })).not.toBeInTheDocument()
  })
  test('renders human overview from backend truth without fake index, portfolio, order or real-time claims', () => {
    render(
      <FinanceObservation
        ...
        initialRiskStatus={riskStatusFixture}
        initialRiskEvaluations={[riskEvaluationFixture]}
      />,
    )
    expect(screen.getAllByText('Bevakade marknaden').at(-1)).toBeVisible()
    expect(screen.getByText(/1 av 2 bevakade instrument steg/)).toBeVisible()
    expect(screen.getByText('▲ POSITIV')).toBeVisible()
    expect(screen.getByText('● NEUTRAL')).toBeVisible()
    expect(screen.getAllByText('24').length).toBeGreaterThanOrEqual(2)
    expect(screen.getByText(/Ingen resultatgraf ännu/)).toBeVisible()
    expect(screen.getByText('Forskningsresultat – inga pengar handlas')).toBeVisible()
    expect(screen.getAllByText('Detaljer & forskning').at(-1)).toBeVisible()
    expect(screen.queryByText(/Nasdaq ↑|S&P 500|portföljvärde|faktisk P\/L|realtid/i)).not.toBeInTheDocument()
    expect(screen.queryByRole('button', { name: /köp|sälj|order|trade/i })).not.toBeInTheDocument()
    expect(screen.getAllByText('Riskbedömning saknas').length).toBe(2)
    expect(screen.getAllByText('research-eod-v1').length).toBeGreaterThan(0)
  ...
  test('matches risk only through exact shadow prediction lineage', () => {
    const exact: FinanceOverview = {
      ...overviewFixture,
      signals: overviewFixture.signals.map((signal, index) => ({
        ...signal,
        predictionIds: index === 0 ? ['shadow-fixture'] : [],
      })),
    }
    render(
      <FinanceObservation
        initialSnapshot={empty}
        initialOverview={exact}
        initialRiskStatus={riskStatusFixture}
        initialRiskEvaluations={[riskEvaluationFixture]}
      />,
    )
    expect(screen.getByText('Risk: Godkänd')).toBeVisible()
    expect(screen.getAllByText('Riskbedömning saknas').length).toBeGreaterThan(0)
  })
  test('aggregates multiple exact risk evaluations conservatively without arbitrary first-match selection', () => {
    const allow = {
      ...
      evaluationId: 'risk-allow',
      shadowPredictionId: 'shadow-a',
      verdict: 'allow' as const,
      evaluatedAtUtc: '2026-08-15T18:00:00Z',
    }
    const deny = {
      ...riskEvaluationFixture,
      evaluationId: 'risk-deny',
      shadowPredictionId: 'shadow-b',
      verdict: 'deny' as const,
      evaluatedAtUtc: '2026-08-15T18:01:00Z',
    }
  ...
  test('renders autonomous research evidence conservatively with progressive details and no profitability claim', () => {
    ...
    expect(screen.getByText(/family-momentum-v1 · REJECTED/)).toBeVisible()
    expect(screen.getByText(/INTEGRITY FAIL/)).toBeVisible()
  ...
  test('renders bounded scheduler status as research-only operations', () => {
    render(
      <FinanceObservation
        initialSnapshot={empty}
        initialAutonomousResearch={autonomousFixture}
        initialResearchScheduler={schedulerFixture}
        initialResearchGovernor={governorFixture}
        initialResearchOperations={operationsFixture}
      />,
    )
    openResearchDetails()
    expect(screen.getByText('AKTIV')).toBeVisible()
    expect(screen.getByText('Completed')).toBeVisible()
    expect(screen.getByText('RESEARCH · 0 SEK · NONE')).toBeVisible()
    expect(screen.getByText('PAUSAD — SYSTEMBELASTNING')).toBeVisible()
    expect(screen.getByText('finance.research.scheduler.resource.memory')).toBeVisible()
    expect(screen.getByText('BEHÖVER UPPMÄRKSAMHET')).toBeVisible()
    expect(screen.getAllByText('3').length).toBeGreaterThan(0)
    expect(screen.queryByText(/trading active/i)).not.toBeInTheDocument()
  })
})

// E1 regression scenarios reproduced from published blocker evidence.
describe('BB-130C E1 robustness selected-result identity', () => {
  const catalog: FinanceRobustnessCatalog = {
    ...
    evaluations: ['A', 'B'].map(id => ({
      ...
      checksum: `checksum-${id}`,
      strategyId: `robustness-${id}`,
      strategyVersion: 'v1',
      planId: `plan-${id}`,
      planVersion: 'v1',
      verdict: 'insufficientData',
      score: id === 'A' ? 11 : 22,
      evidenceLabel: `evidence-${id}`,
      trainSessions: 100,
      testSessions: 20,
      embargoSessions: 50,
      ...
      parameterVariants: 1,
      costVariants: 1,
      featureRevisionId: `feature-${id}`,
      marketRevisionIds: [`market-${id}`],
  ...
  const result = (id: 'A' | 'B'): FinanceRobustnessEvaluation => ({
    ...
    testSessions: 20,
    primarySplit: {
      train: { netReturn: id === 'A' ? 0.11 : 0.22 },
      test: { netReturn: 0.01 },
      netReturnDegradation: 0,
      drawdownDegradation: 0,
      sharpeDegradation: null,
      benchmarkRelativeDegradation: null,
    },
    parameterSensitivity: {
      variantsEvaluated: 1,
      medianNetReturn: 0.01,
      minimumNetReturn: 0.01,
      maximumNetReturn: 0.01,
      returnStandardDeviation: 0,
      medianDrawdown: 0,
      worstDrawdown: 0,
      percentBeatingBenchmark: 0,
      percentPositive: 100,
      verdict: `parameters-${id}`,
      points: [],
    },
    costSensitivity: {
      points: [
        {
          ...
          netReturn: 0.01,
          degradation: 0,
          costBurdenOfGrossPnl: 0,
          trades: 1,
          averageHoldingSessions: 1,
        },
      ],
      estimatedBreakEvenSlippageBps: null,
      rankingStable: true,
    },
    walkForwardWindows: [],
    walkForwardPositivePercent: id === 'A' ? 11 : 22,
    score: { total: id === 'A' ? 11 : 22, label: `evidence-${id}`, components: [] },
    limitations: [],
  })
  const deferred = () => {
    let resolve!: (value: FinanceRobustnessEvaluation) => void
    let reject!: (reason: Error) => void
    const promise = new Promise<FinanceRobustnessEvaluation>((yes, no) => {
      resolve = yes
      reject = no
    })
  ...
  const setup = async () => {
    ...
    const select = (id: 'A' | 'B') =>
      fireEvent.click(panel.getByRole('button', { name: `robustness-${id}insufficientData` }))
  ...
  test('selecting B pending must not display A evidence, including close/reopen', async () => {
    const ui = await setup()
    await act(async () => {
      ui.a.resolve(result('A'))
    })
  ...
  test('late aborted A must not replace already resolved selected B', async () => {
    const ui = await setup()
    ui.select('B')
    expect(ui.detailRead.mock.calls[0][1]?.aborted).toBe(true)
    await act(async () => {
  ...
  test('control: B failure clears detail, no retry control; reselect retries the current identity', async () => {
    ...
    ui.select('B')
    await act(async () => {
      ui.b.reject(new Error('synthetic B unavailable'))
    })
    expect(ui.panel.getByText('evaluation-B / checksum-B')).toBeVisible()
  ...
  test('obsolete rejection cannot erase B or restore A after successful B', async () => {
    const ui = await setup()
    ui.select('B')
    await act(async () => {
      ui.b.resolve(result('B'))
    ...
    ui.coherent('B')
    await act(async () => {
      ui.a.reject(new DOMException('synthetic obsolete abort', 'AbortError'))
    })
    ui.coherent('B')
  })

  test.each(['evaluationId', 'checksum'] as const)('rejects a response with mismatched %s', async field => {
    const ui = await setup()
    await act(async () => {
      ui.a.resolve(result('A'))
    })
    ui.select('B')
    await act(async () => {
      ui.b.resolve({ ...result('B'), [field]: result('A')[field] })
    })
    expect(ui.panel.getByText('evaluation-B / checksum-B')).toBeVisible()
    expect(ui.panel.queryByText('parameters-A')).not.toBeInTheDocument()
    expect(ui.panel.queryByText('parameters-B')).not.toBeInTheDocument()
  })

  test('matching initial evidence is restored only for its own selection; close keeps the selected identity', async () => {
    vi.spyOn(globalThis, 'fetch').mockRejectedValue(new Error('synthetic unrelated read unavailable'))
    const b = deferred()
    const read = vi.spyOn(api, 'getFinanceRobustnessEvaluation').mockReturnValue(b.promise)
    render(<FinanceObservation initialSnapshot={empty} initialRobustness={catalog} initialEvaluation={result('A')} />)
    await act(async () => {
      setResearchOpen(true)
    })
    const panel = within(screen.getByRole('region', { name: 'Robusthet / Out-of-sample' }))
    expect(panel.getByText('parameters-A')).toBeVisible()
    expect(read).not.toHaveBeenCalled()
    fireEvent.click(panel.getByRole('button', { name: 'robustness-BinsufficientData' }))
    expect(panel.queryByText('parameters-A')).not.toBeInTheDocument()
    await act(async () => {
      setResearchOpen(false)
      b.resolve(result('B'))
    })
    ...
    expect(panel.getByText('evaluation-B / checksum-B')).toBeVisible()
    expect(panel.getByText('parameters-B')).toBeVisible()
    fireEvent.click(panel.getByRole('button', { name: 'robustness-AinsufficientData' }))
    expect(panel.getByText('evaluation-A / checksum-A')).toBeVisible()
    expect(panel.getByText('parameters-A')).toBeVisible()
    expect(panel.queryByText('parameters-B')).not.toBeInTheDocument()

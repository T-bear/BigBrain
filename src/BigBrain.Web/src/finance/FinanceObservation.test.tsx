...
import type { FinanceBackupInventory, FinanceFeatureSnapshot, FinanceObservationSnapshot, FinanceOverview, FinanceRobustnessCatalog, FinanceShadowCatalog } from '../types'
...
describe('Finance read-only observation UI', () => {
  ...
  test('renders human overview from backend truth without fake index, portfolio, order or real-time claims',()=>{
    render(<FinanceObservation initialSnapshot={empty} initialOverview={overviewFixture}/>)

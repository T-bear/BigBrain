...
export function createAppWidgetRegistry(data: AppWidgetData) {
  ...
  return new ApplicationWidgetRegistry([
    ...
    { id: 'media-jobs', title: 'Pågående mediajobb', description: 'Aktiva och nyligen avslutade jobb.', icon: '↧', category: 'Media', defaultView: 'media', defaultSize: 'large', minimumSize: 'medium', supportedViews: ['media'], permissions: [], render: () => <MediaJobs showHeading={false} /> },

...
public sealed class FinanceDataProtectionTests
{
    ...
    private sealed class ProtectionFixture : IDisposable
    {
        ...
        internal EodhdMarketMemory Memory { get; }
        internal FinanceDatasetIntakeStore Intake { get; }
        internal FinanceDataProtectionStore Protection { get; }
        internal FinanceDataProtectionOptions ProtectionOptions { get; }
